    ...
    <div>
      ...
      <div>
        ...
        {data?.data.posts.map((post) => (
          <div className="flex items-center justify-between bg-slate-50 p-3 m-2 rounded-md shadow-sm cursor-pointer" onClick={() => selectHandler(post._id)}   key={post._id}>
          <div className="flex items-center gap-3" >
            <button className="hover:bg-Primary p-2 rounded-md hover:text-white" onClick={(e) => {
              e.stopPropagation(); // جلوگیری از اجرای selectHandler
          ...
          <img src={`${url}/${post.images[0]}`} className="w-[100px] h-[70px] rounded-md" alt={post._id} />
